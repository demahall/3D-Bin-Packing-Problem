...
from auxiliary_methods import DEFAULT_NUMBER_OF_DECIMALS,START_POSITION
from visualization import visualize_bin_3d
class Packer:
    def __init__(self):
        self.bins = []
        self.unplaced_items = []
    ...
    def pack(
        ...
        for bin in self.bins:
            ...
            #Collect fitted items for visualization
            ...
            # Visualize the packed bin

            visualize_bin_3d(
                bin_name = bin.size,
                bin_size = (bin.length, bin.width, bin.height),
